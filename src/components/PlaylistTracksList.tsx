...
import { YoutubeTracksList } from './YoutubeTracksList'

import { MixedPlaylistTracksList } from './MixedPlaylistTracksList'
...
export const PlaylistTracksList = ({
	...
	if (platform === 'Youtube') {
		...
		return (
			<MixedPlaylistTracksList
				id={generateTracksListId(id, search)}
				scrollEnabled={false}
				hideQueueControls={true}
				ListHeaderComponentStyle={styles.playlistHeaderContainer}
				ListHeaderComponent={
